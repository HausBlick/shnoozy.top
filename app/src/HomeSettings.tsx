...
export type ModuleId = 'calendar' | 'lists' | 'notes' | 'todos' | 'luna' | 'home-info' | 'car' | 'budget' | 'photo-notes';
...
export const MODULE_META: ModuleMeta[] = [
  ...
  { id: 'photo-notes', emoji: '📸', color: '#e91e8c',           hasSettings: false },
];
...
export function getModuleDesc(id: ModuleId, t: ReturnType<typeof getT>): string {
  switch (id) {
    ...
    case 'photo-notes': return t.modulePhotoNotesDesc;
  }
}
